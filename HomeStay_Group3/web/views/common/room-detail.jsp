            ...
            <div class="main-left">
                ...
                <div class="member-info-container">
                    ...
                    <c:if test="${USER == null}">
                        ...
                        <a href="auth?action=login" class="btn-member">BECOME A MEMBER</a>
                        <div class="member-info-login">
                            Already registered? <a href="auth?action=login">Sign in »</a>
                        </div>
                    </c:if>
                            ...
                            <div class="terms-and-conditions">
                                <label for="termsCheckbox" class="terms-checkbox"
                                    ...
                                    ><input type="checkbox" id="termsCheckbox" checked=""
                                            /></label>
                                <a style="display: block; margin-top: 20px" href="book?action=book&roomId=${ROOM.roomId}" class="btn-request accept">ACCEPT PAYMENT</a>
                            </div>
                        </c:otherwise>
                    </c:choose>
