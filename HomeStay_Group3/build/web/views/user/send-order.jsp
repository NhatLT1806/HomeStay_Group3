...
<html>
                    ...
                    <div class="flex flex-col items-center text-center md:text-left md:items-start">
                        ...
                        <c:choose>
                            <c:when test="${USER.avatar != null}">
                                <img src="data:image/png;base64,${USER.avatar}" alt="Profile picture" id="profile-picture" class=" border-3 border-green-500 p-1 mb-3" style="width: 400px; cursor: pointer; margin: 10px auto;border: 2px solid #1b730d">
                            </c:when>
                            <c:otherwise>
                    ...
                    <div class="mt-8 md:mt-0 md:ml-10 w-full max-w-lg">
                        <form action="VnpayRequestController">
                            <div>
                                ...
                                <input placeholder="10000 vnđ" type="number" name="ammount"  id="inputOne"  class="w-full mt-1 px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent" required>

                                <label for="inputTwo" class>Tiền trong ví (lượt) (10.000vnđ sẽ tương ứng với 1 lượt):</label>
    ...
    <script>
        document.getElementById('inputOne').addEventListener('input', function () {
            ...
            var resultValue = inputOneValue * 0.0001; 
