...
<body class="bg-gray-100 flex items-center justify-center h-screen" style="background: url('${pageContext.request.contextPath}/images/background.jpg') no-repeat ;  background-size: cover; background-origin: border-box   ;">
    <form action="verify" method="post">
        <input type="hidden" name="action" value="setNewPassword"/>
        <div class="bg-white p-6 rounded-lg shadow-md w-96">
            <div class="flex justify-center mb-4">
                <!-- Replace with your actual logo if available -->
                <span class="text-orange-500 font-bold text-2xl" style="color: green;">Hotel</span>
            </div>
